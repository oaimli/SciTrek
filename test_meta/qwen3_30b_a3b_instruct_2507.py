...
if __name__ == "__main__":
    ...
    model_name_official = "Qwen/Qwen3-30B-A3B-Instruct-2507"
    model_name_save = "qwen3_30b_a3b_instruct_2507"
    ...
    sampling_params = SamplingParams(n=3, temperature=0.7, top_p=0.8, top_k=20, max_tokens=4096)
