...
if __name__ == "__main__":
    model_name_official = "meta-llama/Llama-3.3-70B-Instruct"
    model_name_save = "llama33_70b_instruct"
    target_mode = "test_full"
    # sample_level = "64k"  # vllm 75776
    sample_level = "128k"  # vllm 131072
    # sample_level = "512k"  # vllm 131072
    # sample_level = "1024k"  # vllm 131072
    ...
    for sample_index, sample in tqdm(enumerate(samples_test), total=len(samples_test),
        ...
        if "generations" not in sample.keys():
            ...
            if sample_level in ["128k", "512k", "1024k"]:
