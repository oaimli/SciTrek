...
if __name__ == "__main__":
    ...
    with jsonlines.open(generation_folder + "64k_test_full_qwen3_4b_thinking_2507.jsonl") as reader:
        for line in reader:
    ...
    with jsonlines.open(generation_folder + "128k_test_full_qwen3_4b_thinking_2507.jsonl") as reader:
        for line in reader:
    ...
    for sql_template in templates_intersection:
        ...
        for sample in generations_128k:
            if sample["template"] == sql_template:
                ...
                break
    output_text = "\n".join(outputs)
    with open("qwen3_thinking.txt", "w") as f:
        f.write(output_text)
