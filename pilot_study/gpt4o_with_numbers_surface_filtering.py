...
if __name__ == "__main__":
    ...
    instruction = "List the papers that you think have more than 30 references in the reference section. Only output the paper ids."
    print(instruction)
    prompt_content = f"{papers_md_context}\n\n{instruction}"
    with open("example_with_numbers_surface_filtering.txt", "w") as f:
