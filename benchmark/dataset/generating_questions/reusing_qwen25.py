...
if __name__ == "__main__":
    ...
    gpt4_samples_512k = []
    with jsonlines.open("../samples/qwen25/512k_samples_target.jsonl") as reader:
        for line in reader:
            gpt4_samples_512k.append(line)
    gpt4_samples_1024k = []
    with jsonlines.open("../samples/gpt41/1024k_samples_target.jsonl") as reader:
        for line in reader:
    ...
    for prefix in ["64k", "128k", "512k", "1024k", "single"]:
        if prefix == "64k":
            ...
            with jsonlines.open("../samples/qwen25/64k_samples_target.jsonl", "w") as writer:
        ...
        if prefix == "128k":
            ...
            with jsonlines.open("../samples/qwen25/128k_samples_target.jsonl", "w") as writer:
        ...
        if prefix == "single":
            ...
            with jsonlines.open("../samples/qwen25/single_samples_target.jsonl", "w") as writer:
