...
if __name__ == "__main__":
    ...
    gpt4_samples_single = []
    with jsonlines.open("../samples/gpt41/single_samples_target.jsonl") as reader:
        for line in reader:
    ...
    gpt4_samples_128k = []
    with jsonlines.open("../samples/gpt41/128k_samples_target.jsonl") as reader:
        for line in reader:
            gpt4_samples_128k.append(line)
    gpt4_samples_512k = []
    with jsonlines.open("../samples/gpt41/512k_samples_target.jsonl") as reader:
        for line in reader:
    ...
    with jsonlines.open("../samples/gpt41/1024k_samples_target.jsonl", "w") as writer:
